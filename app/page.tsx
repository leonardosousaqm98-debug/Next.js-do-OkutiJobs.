...
const services = [
  { number: "01", title: "Recrutamento especializado", text: "Encontramos profissionais alinhados com a cultura, a função e o momento de crescimento da sua organização." },
  { number: "02", title: "Banco de talentos", text: "Pesquise perfis disponíveis com filtros por competências, experiência, localização e idiomas." },
  { number: "03", title: "Avaliação de competências", text: "Testes psicotécnicos, técnicos, idiomáticos e de raciocínio para decisões mais seguras." },
  { number: "04", title: "Okuti Career AI", text: "Inteligência artificial para ler CVs, destacar competências e aproximar pessoas de oportunidades." },
];
