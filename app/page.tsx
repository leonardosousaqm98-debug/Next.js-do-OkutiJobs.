...
export default async function HomePage() {
  ...
  return <main>
    ...
    <section className="hero-section"><div className="hero-copy"><h1>O próximo passo da sua carreira <em>começa aqui.</em></h1><p className="hero-lede">Ligamos pessoas ambiciosas a organizações que querem crescer melhor — com tecnologia, contexto e acompanhamento humano.</p><div className="hero-actions"><a className="button button-orange" href="#vagas">Explorar oportunidades <span>↗</span></a><a className="text-link" href="#empresas">Sou uma empresa <span>→</span></a></div><div className="hero-proof"><div className="avatar-stack"><i>LM</i><i>AS</i><i>JC</i><b>+</b></div><span>Profissionais a construir o próximo capítulo.</span></div></div><div className="hero-art"><MascotHero /><div className="art-orbit orbit-one" aria-hidden="true"></div><div className="art-orbit orbit-two" aria-hidden="true"></div><div className="art-note note-top">Competência<br /><strong>encontra</strong><br />oportunidade.</div><div className="art-spark">✦</div></div></section>
