...
export default async function HomePage() {
  ...
  return <main>
    ...
    <section className="hero-section"><div className="hero-copy"><h1>O próximo passo da sua carreira <em>começa aqui.</em></h1><p className="hero-lede">Ligamos pessoas ambiciosas a organizações que querem crescer melhor — com tecnologia, contexto e acompanhamento humano.</p><div className="hero-actions"><a className="button button-orange" href="#vagas">Explorar oportunidades <span>↗</span></a><a className="text-link" href="#empresas">Sou uma empresa <span>→</span></a></div><div className="hero-proof"><div className="avatar-stack"><i>LM</i><i>AS</i><i>JC</i><b>+</b></div><span>Profissionais a construir o próximo capítulo.</span></div></div><div className="hero-art"><FlatIllustration className="flat-hero-illustration" src="/manus-storage/okutijobs-flat-hero-team_d712ae0c.png" alt="Equipa de profissionais a trabalhar em conjunto e a fincar uma bandeira no topo de uma colina" loading="eager" /><div className="art-note note-top">Competência<br /><strong>encontra</strong><br />oportunidade.</div><div className="art-spark" aria-hidden="true">✦</div></div></section>
    ...
    <footer className="site-footer"><div className="footer-brand"><a href="/" className="brand"><span className="brand-lockup"><span className="brand-symbol"><img src="/icon.png" alt="" width="34" height="34" /></span><span className="brand-word">Okuti<span>Jobs</span></span></span></a><p>Talento local.<br />Impacto global.</p></div><div className="footer-col"><strong>Explorar</strong><a href="#vagas">Vagas</a><a href="#servicos">Soluções</a><a href="/profile">Perfil candidato</a></div><div className="footer-col"><strong>Para empresas</strong><a href="#empresas">Recrutamento</a><a href="#servicos">Avaliação</a><a href="/pagina-empresas">Solicitar proposta</a></div><div className="footer-col footer-contact"><strong>Fale connosco</strong><a href="mailto:info@okutijobs.com">info@okutijobs.com</a><a href="tel:+244936161636">+244 936 161 636</a><span>Centralidade do Kilamba,<br />Luanda, Angola</span></div><div className="footer-bottom"><span>© 2026 OkutiJobs. Todos os direitos reservados.</span><span>Feito para o próximo capítulo.</span></div></footer>
